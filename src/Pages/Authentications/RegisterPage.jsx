    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-3 py-6">
      <div className="bg-white shadow-xl rounded-2xl w-full max-w-3xl p-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-2 gap-4">
          ...
          <div className="col-span-2">
            <label className="block text-sm font-medium mb-1">ঠিকানা *</label>
            <textarea {...register("address", { required: "ঠিকানা লিখুন" })} placeholder="বিস্তারিত ঠিকানা লিখুন" className="textarea textarea-bordered w-full h-20"></textarea>
          ...
          {role === "seller" && (
            <>
              ...
              <div className="col-span-2">
                ...
                <div className="relative">
                  <FiBriefcase className="absolute left-3 top-3 text-gray-400" />
                  <input {...register("businessName", { required: "ব্যবসার নাম লিখুন" })} type="text" placeholder="দোকান বা ব্যবসার নাম লিখুন" className="input input-bordered w-full pl-10 h-10" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <FiFileText className="absolute left-3 top-3 text-gray-400" />
                  <input {...register("nidNumber", { required: "NID নম্বর দিন", pattern: { value: /^[0-9]{17}$/, message: "১৭ সংখ্যার NID দিন" }})} type="text" placeholder="NID নম্বর লিখুন" className="input input-bordered w-full pl-10 h-10" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <FiCreditCard className="absolute left-3 top-3 text-gray-400" />
                  <input {...register("bankAccount", { required: "ব্যাংক অ্যাকাউন্ট দিন" })} type="text" placeholder="ব্যাংক অ্যাকাউন্ট লিখুন" className="input input-bordered w-full pl-10 h-10" />
                </div>
              </div>
            </>
          )}
          ...
          <div className="col-span-2 mt-4">
            <button type="submit" className="btn w-full bg-black text-white hover:bg-gray-800 transition rounded-md h-11">রেজিস্ট্রেশন করুন</button>
          </div>
        </form>

        {/* Footer */}
        <p className="text-center text-sm text-gray-600 mt-4">
          আগেই অ্যাকাউন্ট আছে? <Link to="/login" className="text-blue-600 hover:underline">লগইন করুন</Link>
        </p>
      </div>
    </div>
  );
