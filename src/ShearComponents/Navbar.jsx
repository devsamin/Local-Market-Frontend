...
// //             {open && (
// //               <div className="absolute right-0 mt-3 w-56 bg-white shadow-lg rounded-lg py-2 border z-50">
...
// //             <Link to="/register" className="px-4 py-2 border border-gray-300 rounded-full text-gray-800 hover:bg-gray-100 transition">
// //               রেজিস্টার
// //             </Link>
// //             <Link to="/login" className="px-4 py-2 bg-black text-white rounded-full hover:bg-gray-900 transition">
// //               লগইন
// //             </Link>
// //           </div>
// //         )}
    ...
    <div className="navbar bg-base-100 shadow-md py-3 px-4 md:px-8 flex justify-between items-center relative">
      ...
      <div className="flex items-center gap-4 relative">
        {user && role === "seller" ? (
          ...
          <Link to="/dashboard" className="btn btn-black px-4 py-2 rounded-full">
            ড্যাশবোর্ড
          </Link>
        ) : (
          // Buyer Cart
